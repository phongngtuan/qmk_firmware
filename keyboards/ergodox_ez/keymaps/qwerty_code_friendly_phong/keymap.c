...
* '--------+------+------+------+------+-------------'  '-------------+------+------+------+------+--------'
*   | LCtl |Super | Alt  | App  | Menu |                              | Left | Right|   [  |  ]   | Del  |
*   '----------------------------------'                              '----------------------------------'
*                                      .-------------.  .-------------.
*                                      |BSpace| Del  |  | Home | End  |
*                               .------+------+------|  |------+------+------.
...
[LAYER_BASE] = LAYOUT_ergodox_76_or_80(  /* layer 0 : default */
  ...
  /* right hand */
  KC_EQL,      KC_6,    KC_7,    KC_8,   KC_9,    KC_0,      CFQ_USER_KEY9,
...
[LAYER_KPAD] = LAYOUT_ergodox_76_or_80(
  ...
  /* right hand */
  M_BRACKET_OUT_CBR, KC_TRNS,           KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,
  M_BRACKET_OUT_PRN, M_ARROW_LEQL,      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,
                     KC_LEFT,           KC_DOWN, KC_UP,   KC_RGHT, KC_TRNS,  KC_TRNS,
  M_BRACKET_OUT_BRC, M_BRACKET_OUT_ANG, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,
                                        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,
  KC_TRNS, KC_TRNS,
...
[LAYER_FKEY] = LAYOUT_ergodox_76_or_80(
  ...
  KC_VOLD,  KC_TRNS, KC_1,    KC_2,    KC_3,    KC_TRNS, KC_TRNS,
                     KC_TRNS, KC_TRNS, KC_F11,  KC_F12,  KC_TRNS,
  KC_MRWD, KC_MFFD,
